...
class ResultController extends Controller
{
    public function view(){
    	...
    	return view('admin.pages.result.view-result', compact('results'));
    }

    public function add(){
    	$data['GameTime'] = GameTime::all();
    	return view('admin.pages.result.add-result', $data);
    }
    ...
    public function store(Request $request){
    	...
    	return redirect()->route('admin.result.view')->with('success', 'Result Entry Success');
