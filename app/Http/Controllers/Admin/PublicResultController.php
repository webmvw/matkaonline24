...
class PublicResultController extends Controller
{
    public function view(){
    	...
    	return view('admin.pages.public-result.view-public-result', compact('getResult'));
    }

    public function add(){
    	$data['bazars'] = Bazar::orderBy('id', 'desc')->get();
    	return view('admin.pages.public-result.add-public-result', $data);
    }
    ...
    public function store(Request $request){
		...
		$public_result->save();
		return redirect()->route('admin.public_result.view')->with('success', 'Result Entry Success');
    }
    ...
    public function edit($id){
        ...
        $data['bazars'] = Bazar::orderBy('id', 'desc')->get();
        return view('admin.pages.public-result.edit-public-result', $data);  
    }
    ...
    public function update(Request $request, $id){
        ...
        $public_result->number = $request->number;
        $public_result->save();
        return redirect()->route('admin.public_result.view')->with('success', 'Result Update Success');
    }
