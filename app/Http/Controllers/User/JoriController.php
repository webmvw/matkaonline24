...
class JoriController extends Controller
{
    public function view(){
    	return view('user.pages.jori.jori-view');
    }
    ...
    public function store(Request $request){
    	...
    	if($request->bazar == null){
    		...
    		if($total_point > $user_current_balance){
	    		...
	    		return redirect()->route('user.jori_game.view')->with("success", "Successfully Submited!!");
    		}
    	}
    }
}
