...
class TriplePattiController extends Controller
{
    public function view(){
    	return view('user.pages.triple-patti.triple-patti-view');
    }
    ...
    public function store(Request $request){
    	...
    	if($request->bazar == null){
    		...
    		if($total_point > $user_current_balance){
	    		...
	    		return redirect()->route('user.triple_patti.view')->with("success", "Successfully Submited!!");
    		}
    	}
    }
}
