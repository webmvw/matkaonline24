...
class DoublePattiController extends Controller
{
    public function view(){
    	return view('user.pages.double-patti.double-patti-view');
    }
    ...
    public function store(Request $request){
    	...
    	if($request->bazar == null){
    		...
    		if($total_point > $user_current_balance){
	    		...
	    		return redirect()->route('user.double_patti.view')->with("success", "Successfully Submited!!");
    		}
    	}
    }
}
