          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('employee.public_result.view') }}" class="btn btn-sm" style="background: #f39902"><i class="fa fa-list"></i> View Result</a>
              </div>

              <!-- /.card-header -->
                 <form method="post" action="{{ route('employee.public_result.store') }}" id="quickForm" novalidate="novalidate" class="form-prevent-multiple-submits"> 
                  @csrf
                    <div class="card-body">
