        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="{{ route('Admin.Update.Password') }}" id="quickForm" novalidate="novalidate" enctype="multipart/form-data" class="form-prevent-multiple-submits"> 
                  @csrf
